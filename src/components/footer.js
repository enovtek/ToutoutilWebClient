...
export class Footer extends React.Component
{
	...
	var logoDown={ 'marginLeft':'345'};
	return(
		<div className="footer navbaRr-fixed-bottom" style={{marginTop:'350px'}}>
			<footer className="page-footer fixed-bottom font-small blue" style={{backgroundColor:'#000'}}>
				<div className="footer-copyright text-center py-3">Copyright &copy;2020&nbsp;
					<strong><a href="http://.io"><font color="yellow">tOUtOUtil.co</font></a></strong>
						&nbsp;All rights reserved.
				</div>
			</footer>
		</div>
